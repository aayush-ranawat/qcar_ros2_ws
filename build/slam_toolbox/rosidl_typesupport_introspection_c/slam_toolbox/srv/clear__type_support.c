...
#include <stddef.h>
#include "slam_toolbox/srv/clear__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers slam_toolbox__srv__clear__rosidl_typesupport_introspection_c__Clear_service_members = {
  "slam_toolbox__srv",  // service namespace
  "Clear",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // slam_toolbox__srv__clear__rosidl_typesupport_introspection_c__Clear_Request_message_type_support_handle,
  NULL  // response message
  // slam_toolbox__srv__clear__rosidl_typesupport_introspection_c__Clear_Response_message_type_support_handle
};

static rosidl_service_type_support_t slam_toolbox__srv__clear__rosidl_typesupport_introspection_c__Clear_service_type_support_handle = {
  0,
  &slam_toolbox__srv__clear__rosidl_typesupport_introspection_c__Clear_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_toolbox, srv, Clear)() {
  if (!slam_toolbox__srv__clear__rosidl_typesupport_introspection_c__Clear_service_type_support_handle.typesupport_identifier) {
    slam_toolbox__srv__clear__rosidl_typesupport_introspection_c__Clear_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)slam_toolbox__srv__clear__rosidl_typesupport_introspection_c__Clear_service_type_support_handle.data;
  ...
  return &slam_toolbox__srv__clear__rosidl_typesupport_introspection_c__Clear_service_type_support_handle;
}
