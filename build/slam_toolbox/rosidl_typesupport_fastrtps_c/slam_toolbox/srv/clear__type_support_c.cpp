...
#include "slam_toolbox/srv/clear__rosidl_typesupport_fastrtps_c.h"
...
using _Clear_Request__ros_msg_type = slam_toolbox__srv__Clear_Request;
...
size_t get_serialized_size_slam_toolbox__srv__Clear_Request(
  const void * untyped_ros_message,
...
static uint32_t _Clear_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_slam_toolbox__srv__Clear_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_slam_toolbox
size_t max_serialized_size_slam_toolbox__srv__Clear_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _Clear_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_slam_toolbox__srv__Clear_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_toolbox, srv, Clear_Request)() {
...
using _Clear_Response__ros_msg_type = slam_toolbox__srv__Clear_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_slam_toolbox
size_t get_serialized_size_slam_toolbox__srv__Clear_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Clear_Response__ros_msg_type * ros_message = static_cast<const _Clear_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_slam_toolbox__srv__Clear_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_slam_toolbox
size_t max_serialized_size_slam_toolbox__srv__Clear_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _Clear_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_slam_toolbox__srv__Clear_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_toolbox, srv, Clear_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_toolbox, srv, Clear)() {
