...
#include "slam_toolbox/srv/toggle_interactive__rosidl_typesupport_fastrtps_c.h"
  ...
  void * untyped_ros_message)
{
  ...
  _ToggleInteractive_Request__ros_msg_type * ros_message = static_cast<_ToggleInteractive_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
...
{
  return max_serialized_size_slam_toolbox__srv__ToggleInteractive_Request(
    full_bounded, 0);
}
  ...
  void * untyped_ros_message)
{
  ...
  _ToggleInteractive_Response__ros_msg_type * ros_message = static_cast<_ToggleInteractive_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
...
{
  return max_serialized_size_slam_toolbox__srv__ToggleInteractive_Response(
    full_bounded, 0);
}
