...
#include "slam_toolbox/srv/pause__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return max_serialized_size_Pause_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_Pause_Response(full_bounded, 0);
}
