...
#include "slam_toolbox/srv/clear__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const slam_toolbox::srv::Clear_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<slam_toolbox::srv::Clear_Request *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Clear_Request(full_bounded, 0);
}
...
{
  return &slam_toolbox::srv::typesupport_fastrtps_cpp::_Clear_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const slam_toolbox::srv::Clear_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<slam_toolbox::srv::Clear_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return max_serialized_size_Clear_Response(full_bounded, 0);
}
...
{
  return &slam_toolbox::srv::typesupport_fastrtps_cpp::_Clear_Response__handle;
}
...
{
  return &slam_toolbox::srv::typesupport_fastrtps_cpp::_Clear__handle;
}
