...
#include "slam_toolbox/srv/deserialize_pose_graph__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return max_serialized_size_DeserializePoseGraph_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_DeserializePoseGraph_Response(full_bounded, 0);
}
