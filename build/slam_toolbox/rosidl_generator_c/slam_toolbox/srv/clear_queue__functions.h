...
#ifndef SLAM_TOOLBOX__SRV__CLEAR_QUEUE__FUNCTIONS_H_
#define SLAM_TOOLBOX__SRV__CLEAR_QUEUE__FUNCTIONS_H_
...
#endif  // SLAM_TOOLBOX__SRV__CLEAR_QUEUE__FUNCTIONS_H_
