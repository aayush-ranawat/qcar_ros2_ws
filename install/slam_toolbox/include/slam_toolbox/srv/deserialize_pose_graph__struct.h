...
#ifndef SLAM_TOOLBOX__SRV__DESERIALIZE_POSE_GRAPH__STRUCT_H_
#define SLAM_TOOLBOX__SRV__DESERIALIZE_POSE_GRAPH__STRUCT_H_
...
#endif  // SLAM_TOOLBOX__SRV__DESERIALIZE_POSE_GRAPH__STRUCT_H_
