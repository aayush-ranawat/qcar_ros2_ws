...
#ifndef SLAM_TOOLBOX__SRV__DESERIALIZE_POSE_GRAPH__STRUCT_HPP_
#define SLAM_TOOLBOX__SRV__DESERIALIZE_POSE_GRAPH__STRUCT_HPP_
...
struct DeserializePoseGraph_Request_
{
  ...
  explicit DeserializePoseGraph_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : initial_pose(_init)
  {
  ...
  explicit DeserializePoseGraph_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : filename(_alloc),
...
struct DeserializePoseGraph_Response_
{
  ...
  explicit DeserializePoseGraph_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit DeserializePoseGraph_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // SLAM_TOOLBOX__SRV__DESERIALIZE_POSE_GRAPH__STRUCT_HPP_
