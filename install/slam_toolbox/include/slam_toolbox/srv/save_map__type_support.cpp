...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SaveMap_Request_message_member_array[1] = {
  {
    ...
    offsetof(slam_toolbox::srv::SaveMap_Request, name),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SaveMap_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(slam_toolbox::srv::SaveMap_Request),
...
{
  return &::slam_toolbox::srv::rosidl_typesupport_introspection_cpp::SaveMap_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, slam_toolbox, srv, SaveMap_Request)() {
  return &::slam_toolbox::srv::rosidl_typesupport_introspection_cpp::SaveMap_Request_message_type_support_handle;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SaveMap_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(slam_toolbox::srv::SaveMap_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SaveMap_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(slam_toolbox::srv::SaveMap_Response),
...
{
  return &::slam_toolbox::srv::rosidl_typesupport_introspection_cpp::SaveMap_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, slam_toolbox, srv, SaveMap_Response)() {
  return &::slam_toolbox::srv::rosidl_typesupport_introspection_cpp::SaveMap_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SaveMap_service_members = {
  ...
  // see get_service_type_support_handle<slam_toolbox::srv::SaveMap>()
...
get_service_type_support_handle<slam_toolbox::srv::SaveMap>()
{
  ...
  auto service_type_support =
    &::slam_toolbox::srv::rosidl_typesupport_introspection_cpp::SaveMap_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, slam_toolbox, srv, SaveMap)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<slam_toolbox::srv::SaveMap>();
}
