...
#ifndef SLAM_TOOLBOX__SRV__SAVE_MAP__STRUCT_HPP_
#define SLAM_TOOLBOX__SRV__SAVE_MAP__STRUCT_HPP_
...
struct SaveMap_Response_
{
  ...
  explicit SaveMap_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SaveMap_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // SLAM_TOOLBOX__SRV__SAVE_MAP__STRUCT_HPP_
