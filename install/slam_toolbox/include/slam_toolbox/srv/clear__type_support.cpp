...
#include "slam_toolbox/srv/clear__struct.hpp"
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Clear_Request_message_member_array[1] = {
  {
    ...
    offsetof(slam_toolbox::srv::Clear_Request, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Clear_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(slam_toolbox::srv::Clear_Request),
...
{
  return &::slam_toolbox::srv::rosidl_typesupport_introspection_cpp::Clear_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, slam_toolbox, srv, Clear_Request)() {
  return &::slam_toolbox::srv::rosidl_typesupport_introspection_cpp::Clear_Request_message_type_support_handle;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Clear_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(slam_toolbox::srv::Clear_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Clear_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(slam_toolbox::srv::Clear_Response),
...
{
  return &::slam_toolbox::srv::rosidl_typesupport_introspection_cpp::Clear_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, slam_toolbox, srv, Clear_Response)() {
  return &::slam_toolbox::srv::rosidl_typesupport_introspection_cpp::Clear_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Clear_service_members = {
  ...
  // see get_service_type_support_handle<slam_toolbox::srv::Clear>()
...
get_service_type_support_handle<slam_toolbox::srv::Clear>()
{
  ...
  auto service_type_support =
    &::slam_toolbox::srv::rosidl_typesupport_introspection_cpp::Clear_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::slam_toolbox::srv::Clear_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::slam_toolbox::srv::Clear_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, slam_toolbox, srv, Clear)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<slam_toolbox::srv::Clear>();
}
