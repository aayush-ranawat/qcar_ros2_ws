...
#ifndef SLAM_TOOLBOX__SRV__TOGGLE_INTERACTIVE__STRUCT_H_
#define SLAM_TOOLBOX__SRV__TOGGLE_INTERACTIVE__STRUCT_H_
...
#endif  // SLAM_TOOLBOX__SRV__TOGGLE_INTERACTIVE__STRUCT_H_
