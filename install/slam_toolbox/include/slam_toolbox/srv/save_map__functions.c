...
{
  slam_toolbox__srv__SaveMap_Request * msg = (slam_toolbox__srv__SaveMap_Request *)malloc(sizeof(slam_toolbox__srv__SaveMap_Request));
  if (!msg) {
    return NULL;
  }
...
slam_toolbox__srv__SaveMap_Request__Sequence__init(slam_toolbox__srv__SaveMap_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (slam_toolbox__srv__SaveMap_Request *)calloc(size, sizeof(slam_toolbox__srv__SaveMap_Request));
    if (!data) {
      return false;
    }
...
{
  slam_toolbox__srv__SaveMap_Request__Sequence * array = (slam_toolbox__srv__SaveMap_Request__Sequence *)malloc(sizeof(slam_toolbox__srv__SaveMap_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  slam_toolbox__srv__SaveMap_Response * msg = (slam_toolbox__srv__SaveMap_Response *)malloc(sizeof(slam_toolbox__srv__SaveMap_Response));
  if (!msg) {
    return NULL;
  }
...
slam_toolbox__srv__SaveMap_Response__Sequence__init(slam_toolbox__srv__SaveMap_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (slam_toolbox__srv__SaveMap_Response *)calloc(size, sizeof(slam_toolbox__srv__SaveMap_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  slam_toolbox__srv__SaveMap_Response__Sequence * array = (slam_toolbox__srv__SaveMap_Response__Sequence *)malloc(sizeof(slam_toolbox__srv__SaveMap_Response__Sequence));
  if (!array) {
    return NULL;
  }
