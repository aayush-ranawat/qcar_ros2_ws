...
#ifndef SLAM_TOOLBOX__SRV__LOOP_CLOSURE__TYPE_SUPPORT_H_
#define SLAM_TOOLBOX__SRV__LOOP_CLOSURE__TYPE_SUPPORT_H_
...
#endif  // SLAM_TOOLBOX__SRV__LOOP_CLOSURE__TYPE_SUPPORT_H_
